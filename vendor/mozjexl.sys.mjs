...
handlers$3.BinaryExpression = function (ast) {
  var self = this;
  return Promise.all([this.eval(ast.left), this.eval(ast.right)]).then(
    function (arr) {
 ...
 * @private
 */
handlers$3.Transform = function (ast) {
 ...
 * @constructor
 */
var Evaluator$1 = function (grammar, transforms, context, relativeContext) {
 ...
 */
Evaluator$1.prototype.eval = function (ast) {
  var self = this;
  return Promise.resolve().then(function () {
    return handlers$2[ast.type].call(self, ast);
  });
};
 ...
 */
Evaluator$1.prototype.evalArray = function (arr) {
  return Promise.all(
 ...
 */
Evaluator$1.prototype.evalMap = function (map) {
 ...
 * @private
 */
Evaluator$1.prototype._filterRelative = function (subject, expr) {
  if (subject === undefined) return undefined;
  var promises = [];
  if (!Array.isArray(subject)) subject = [subject];
  subject.forEach(function (elem) {
    var evalInst = new Evaluator$1(
      this._grammar,
      this._transforms,
      this._context,
      elem
 ...
 * @private
 */
Evaluator$1.prototype._filterStatic = function (subject, expr) {
 ...
 */
Lexer$1.prototype.getElements = function (str) {
 ...
 */
Lexer$1.prototype.getTokens = function (elements) {
  var tokens = [],
    negate = false;
 ...
 */
Lexer$1.prototype.tokenize = function (str) {
 ...
 * @private
 */
Lexer$1.prototype._createToken = function (element) {
  var token = {
    type: "literal",
    value: element,
    raw: element,
 ...
 * @private
 */
Lexer$1.prototype._escapeRegExp = function (str) {
  str = str.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
 ...
 * @private
 */
Lexer$1.prototype._getSplitRegex = function () {
  if (!this._splitRegex) {
 ...
 * @private
 */
Lexer$1.prototype._isNegative = function (tokens) {
...
Lexer$1.prototype._isWhitespace = function (str) {
 ...
 * @private
 */
Lexer$1.prototype._isComment = function (str) {
 ...
 * @private
 */
Lexer$1.prototype._unquote = function (str) {
  var quote = str[0],
 ...
 * @constructor
 */
function Parser$1(grammar, prefix, stopMap) {
  this._grammar = grammar;
 ...
 */
Parser$1.prototype.addToken = function (token) {
 ...
 */
Parser$1.prototype.addTokens = function (tokens) {
 ...
 */
Parser$1.prototype.complete = function () {
 ...
 */
Parser$1.prototype.isRelative = function () {
 ...
 * @private
 */
Parser$1.prototype._endSubExpression = function () {
 ...
 * @private
 */
Parser$1.prototype._placeAtCursor = function (node) {
 ...
 * @private
 */
Parser$1.prototype._placeBeforeCursor = function (node) {
 ...
 * @private
 */
Parser$1.prototype._setParent = function (node, parent) {
 ...
 * @private
 */
Parser$1.prototype._startSubExpression = function (exprStr) {
  var endStates = states[this._state].endStates;
  if (!endStates) {
    this._parentStop = true;
    endStates = this._stopMap;
  }
  this._subParser = new Parser$1(this._grammar, exprStr, endStates);
};
...
var Evaluator = Evaluator_1,
  Lexer = Lexer_1,
  Parser = Parser_1,
  defaultGrammar = grammar.elements;
...
Jexl$2.exports = new Jexl();
var Jexl_2 = Jexl$2.exports.Jexl = Jexl;

var JexlExports = Jexl$2.exports;
var Jexl$1 = /*@__PURE__*/getDefaultExportFromCjs(JexlExports);

export { Jexl_2 as Jexl, Jexl$1 as default };
